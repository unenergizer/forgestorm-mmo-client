...
public class MapUtil {
     ...
     */
    public static boolean isTraversable(TmxMap tmxMap, int x, int y) {
     ...
     */
    public static boolean isOutOfBounds(TmxMap tmxMap, int x, int y) {
        return x < 0 || x >= tmxMap.getMapWidth() || y < 0 || y >= tmxMap.getMapHeight();
    }

    public static Warp getWarp(TmxMap tmxMap, int x, int y) {
        return tmxMap.getMap()[x][y].getWarp();
    }

    public static boolean hasWarp(TmxMap tmxMap, int x, int y) {
