...
public class ClientMoveResyncPacketIn implements PacketListener<ClientMoveResyncPacketIn.ClientMoveResyncPacket> {
    ...
    public ClientMoveResyncPacketIn(ClientMain clientMain) {
    ...
    public void onEvent(ClientMoveResyncPacket packetData) {
        ...
        Location resyncLocation = new Location(clientMain, playerClient.getWorldName(), packetData.futureX, packetData.futureY, packetData.futureZ);
    ...
    @AllArgsConstructor
    static class ClientMoveResyncPacket extends PacketData {
