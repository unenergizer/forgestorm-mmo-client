...
<tileset name="[Cave] Cave_A" tilewidth="16" tileheight="16" tilecount="60" columns="5">
 <image source="../../textures/cave1.0/cave_A.png" width="80" height="192"/>
 <terraintypes>
  <terrain name="Floor 1" tile="0"/>
  <terrain name="Floor 2" tile="0"/>
  <terrain name="Floor 3" tile="0"/>
  <terrain name="Wall 1" tile="0"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
